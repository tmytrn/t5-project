...
const Period = ({ period, data }) => {
  ...
  return (
    <>
      ...
      <main className="pt-[56px] h-screen">
        ...
        >
          <div className={isDiscOpen ? "hidden" : "visible"}>
            <div className="font-serif absolute w-full text-center text-[190px] top-[24px] left-0 stroked-text z-[0] ">
              {start}
            </div>
            <div className="absolute w-full top-[80px] flex justify-between z-50">
              <span className="border-saddle border-solid border-t-[1px] w-4"></span>
              <span className="border-saddle border-solid border-t-[1px] w-4"></span>
            </div>
          </div>
          {data.future && (
            <div className="absolute w-full font-sans py-1 ">
              <div className="absolute w-full flex flex-col items-center snap-center justify-center z-50">
          ...
          <div
            className={
              isDiscOpen ? "hidden" : "visible bay-illustration z-30 relative"
            }
          >
          ...
          <div className="flex flex-col w-full absolute bottom-0 left-0">
            ...
            {data.past && (
              <div className="py-2 font-sans w-full pb-4 z-10">
                <Link href={`/period/${data.past}`}>
                  <a className="flex flex-col items-center snap-center justify-center">
